...
Go to https://rawg.io/apidocs and get an API key 
which you’ll use as part of the endpoint you’re making an API call to. 
You can use https://noroff.no for the URL and 
Noroff Assignment for the description.

You'll be given an API Key you can add as a "key" parameter in your fetch request.

// key: b8779db90aa54327b347c21f9fc1d52a
...
const endpointURL = "https://api.rawg.io/api/games?dates=2019-01-01,2019-12-31&ordering=-rating&key=b8779db90aa54327b347c21f9fc1d52a";
...
in HTML,but only for the first eight results:*/
        for (let i = 0; i < results.length; i++) {
            ...
            <h2>Title: ${results[i].name}</h2>
            <h2>Rating: ${rating}</h2>
            <h2>This element has ${numberOfTags} tags</h2>
            </div>`
        }
    })
...
Submission
Create a repository in your GitHub account called your-name-js1-ma3, for example mary-smith-js1-ma3, 
